...
#téléchargement des packages nécéssaire pour l'entierté du code:
rm(list=ls()) 
library(readxl)
library(dplyr)
library(tidytext)
...
civ88_mort <- read_dta("Downloads/civ88_mort.dta")
View(civ88_mort)

#Graphique permettant de visualiser la distribution de l'âge des mères:

hist(age_m, breaks = 15, prob = TRUE, col = "lightpink", main = "Distribution de l'âge des mères", xlab = "Âge")
lines(density(age_m), col = "black", lwd = 2)
